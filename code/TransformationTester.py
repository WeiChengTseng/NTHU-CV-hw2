...
# saveFileName = '../results/Hanging_pano.png'
# img1Path = '../data/Hanging1.png'
# img2Path = '../data/Hanging2.png'

# saveFileName = '../results/MelakwaLake_pano.png'
# img1Path = '../data/MelakwaLake1.png'
# img2Path = '../data/MelakwaLake2.png'
...
#%% Transformation
maxIter = 500
maxInlierErrorPixels = 0.01*len(np.asarray(img1))
seedSetSize = np.max([3, np.ceil(0.5 * len(M))])
minInliersForAcceptance = np.ceil(0.2 * len(M))   
